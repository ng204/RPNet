...
def parse_args():
    ...
    parser.add_argument(
        '--config',
        default=('/root/mmaction2/configs/skeleton/stgcn/stgcn_8xb16-joint-u100-80e_ntu60-xsub-keypoint-2d.py'),
        help='skeleton model config file path')
    parser.add_argument(
        '--checkpoint',
        default=('/root/mmaction2/work_dirs/stgcn_8xb16-joint-u100-80e_ntu60-xsub-keypoint-2d/best_acc_top1_epoch_61.pth'),
