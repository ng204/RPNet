ann_file = '/root/mmaction2/tools/data/skeleton/my_train.pkl'
...
data_root = '/root/mmaction2/videos/'
...
test_dataloader = dict(
    ...
    dataset=dict(
        ann_file='/root/mmaction2/tools/data/skeleton/my_train.pkl',
        data_prefix=dict(video='/root/mmaction2/videos/'),
        pipeline=[
            dict(
...
work_dir = './work_dirs/rgbpose_conv3d-ep100'
