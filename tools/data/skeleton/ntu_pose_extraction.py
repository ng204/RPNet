...
args.det_config = '/root/mmdetection/work_dirs/rtmdet_l_8xb32-300e_coco/rtmdet_l_8xb32-300e_coco.py'  # noqa: E501
args.det_checkpoint = '/root/mmdetection/work_dirs/rtmdet_l_8xb32-300e_coco/epoch_120.pth'  # noqa: E501
args.det_score_thr = 0.2
args.pose_config = '/root/mmpose/work_dirs/td-hm_hrnet-w32_8xb64-210e_coco-256x192/td-hm_hrnet-w32_8xb64-210e_coco-256x192.py'  # noqa: E501
args.pose_checkpoint = '/root/mmpose/work_dirs/td-hm_hrnet-w32_8xb64-210e_coco-256x192/best_coco_AP_epoch_190.pth'  # noqa: E501
...
def ntu_pose_extraction(vid, skip_postproc=False):
    ...
    anno['img_shape'] = (shape[0], shape[1])
    anno['original_shape'] = (shape[0], shape[1])
