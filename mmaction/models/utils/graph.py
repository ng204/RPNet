    ...
    def set_layout(self, layout: str) -> None:
        ...
        if layout == 'openpose':
            ...
            self.inward = [(15, 13), (13, 11), (16, 14), (14, 12), (11, 5),
                           ...
                           (6, 0), (1, 0), (3, 1), (2, 0), (4, 2)]
            self.center = 0
        elif layout == 'custom':  # 添加自定义布局
            self.num_node = 16  # 16个关键点
            self.inward = [
                (0, 1),  # nose -> Head_top
                (1, 2),  # Head_top -> Spine
                (2, 9),  # Spine -> Coccyx
                (2, 3),  # Spine -> Left_FTR
                (3, 4),  # Left_FTR -> Left_FK
                (4, 5),  # Left_FK -> Left_FH
                (9, 6),  # Coccyx -> Left_HTR
                (6, 7),  # Left_HTR -> Left_HK
                (7, 8),  # Left_HK -> Left_HH
                (2, 10), # Spine -> Right_FTR
                (10, 11),# Right_FTR -> Right_FK
                (11, 12),# Right_FK -> Right_FH
                (9, 13), # Coccyx -> Right_HT
                (13, 14),# Right_HT -> Right_HK
                (14, 15) # Right_HK -> Right_HH
            ]
            self.center = 1  # 假设 Head_top 为中心点
